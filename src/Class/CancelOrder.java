...
public class CancelOrder {
    public void Cancelorder(String vendorname, String customerid, String food, String quantity, String price, String date, String dtd, String address) {
        ...
        try {
            ...
            try {
                while (dis.available()>0) {
                    ...
                    if (!(cid.equals(customerid) && vndornm.equals(vendorname) && foodnm.equals(food) && dt.equals(date) && tdt.equals(dtd) && add.equals(address))) {
                        item.add(cid);
                        item.add(vndornm);
                        item.add(foodnm);
                        item.add(qtt);
